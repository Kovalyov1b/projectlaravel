...
<div class="flex" style="justify-content: center;">
    <form method="post" action="{{route('new-form')}}">
        @csrf
        <div class="mb-3">
            <label class="form-label" style="color: orange; font-size: 25px">Full name</label>
        ...
        <label class="form-label" style="color: orange; font-size: 25px">Address</label>

        <input type="text" class="form-control" id="streetaddress" required name="streetaddress">
        <div class="form-text">Street Address</div>

        <input type="text" class="form-control" id="streetaddressline2" required name="streetaddressline2" >
        ...
        <label class="form-label" style="color: orange; font-size: 25px">Phone number</label>
        <input type="tel" name="phone" required class="form-control" id="phone">

        <label class="form-label" style="color: orange; font-size: 25px">E-mail</label>
